...
class NavierStokes():
    ...
    def momentum_equation(self, v):
        ...
        diffusion = diffuse.finite_difference(v, self.viscosity, order=2, implicit=None)
...
class NavierStokes_pipeline():
    ...
    # Figure out how this correction part will work
    def momentum_equation_corrected(self, v, model):
